...
Curso personal, en formato de apunte incremental, para aprender a usar Claude
...
- [x] [Módulo 6 — Publicar en GitHub y flujo de trabajo final](docs/modulo-6.md)
...
Ver [`CLAUDE.md`](CLAUDE.md) para las reglas de trabajo y el estado de avance
que usa Claude para retomar el curso entre sesiones.
